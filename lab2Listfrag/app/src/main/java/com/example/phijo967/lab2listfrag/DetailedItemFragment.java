 ...
 * {@link DetailedItemFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DetailedItemFragment#newInstance} factory method to
...
public class DetailedItemFragment extends Fragment {
    ...
    private ExampleContent.TestItem myItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            myItem = ExampleContent.ITEM_MAP.get(getArguments().getString(ARG_PARAM1));
        }
    }
